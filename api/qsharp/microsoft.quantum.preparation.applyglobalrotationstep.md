...
title: Bewerking ApplyGlobalRotationStep
...
ms.locfileid: "98855921"
---
# <a name="applyglobalrotationstep-operation"></a>Bewerking ApplyGlobalRotationStep
...
### <a name="angle--double"></a>hoek: [dubbel](xref:microsoft.quantum.lang-ref.double)
