...
---
# <a name="_prepareclassification-operation"></a>_PrepareClassification bewerking
...
### <a name="encoder--littleendian--unit--is-adj--ctl"></a>Encoder: [LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian) => [Unit](xref:microsoft.quantum.lang-ref.unit)  is ADJ en CTL
