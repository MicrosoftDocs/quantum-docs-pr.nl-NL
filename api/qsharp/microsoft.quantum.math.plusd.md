...
ms.locfileid: "96227587"
---
# <a name="plusd-function"></a>Functie samengeteld
...
Retourneert de som van twee invoer waarden.
...
De eerste invoer $a $ die moet worden opgeteld.


### <a name="b--double"></a>b: [dubbel](xref:microsoft.quantum.lang-ref.double)

De tweede invoer $b $ moet worden opgeteld.
