...
ms.locfileid: "96215466"
---
# <a name="_optimizedqubitizationoracleseperatedregisters_-function"></a>De functie _OptimizedQubitizationOracleSeperatedRegisters_
...
## <a name="output--intintdoublequbitqubit--unit--is-adj--ctl"></a>Output: (([int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)), ([Double](xref:microsoft.quantum.lang-ref.double), ([Qubit](xref:microsoft.quantum.lang-ref.qubit)[],[Qubit](xref:microsoft.quantum.lang-ref.qubit)[]) => [eenheid](xref:microsoft.quantum.lang-ref.unit)  is ADJ en CTL))
