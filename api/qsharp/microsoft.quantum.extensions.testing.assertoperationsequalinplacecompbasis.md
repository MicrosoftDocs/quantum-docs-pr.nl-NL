...
ms.locfileid: "96199214"
---
# <a name="assertoperationsequalinplacecompbasis-operation"></a>Bewerking AssertOperationsEqualInPlaceCompBasis

Naam ruimte: [micro soft. Quantum. Extensions. test doeleinden](xref:Microsoft.Quantum.Extensions.Testing)

Pakket: [micro soft. Quantum. QSharp. core](https://nuget.org/packages/Microsoft.Quantum.QSharp.Core)


> [!WARNING]
> AssertOperationsEqualInPlaceCompBasis is afgeschaft. Gebruik <xref:Microsoft.Quantum.Diagnostics.AssertOperationsEqualInPlaceCompBasis> in plaats daarvan.
>
> Gebruik @"microsoft.quantum.diagnostics.assertoperationsequalinplaceCompBasis".
> Houd er rekening mee dat de volg orde van de argumenten voor deze bewerking is gewijzigd.
