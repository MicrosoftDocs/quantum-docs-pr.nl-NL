...
---
# <a name="entrypoint-user-defined-type"></a>Door gebruiker gedefinieerd type entry point
...
Een door het compiler herkend kenmerk dat wordt gebruikt om het ingangs punt van een uitvoerbaar bestand te markeren.
