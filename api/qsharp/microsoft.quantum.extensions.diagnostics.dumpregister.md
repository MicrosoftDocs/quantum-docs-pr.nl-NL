...
> [!WARNING]
> DumpRegister is afgeschaft. Gebruik <xref:Microsoft.Quantum.Diagnostics.DumpRegister> in plaats daarvan.
>
> Gebruik @"microsoft.quantum.diagnostics.dumpregister".
