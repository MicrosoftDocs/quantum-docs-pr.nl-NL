...
---
# <a name="applytargetstatereflectionoracle-operation"></a>Bewerking ApplyTargetStateReflectionOracle
...
Implementatie van <xref:microsoft.quantum.canon.targetstatereflectionoracle> .
