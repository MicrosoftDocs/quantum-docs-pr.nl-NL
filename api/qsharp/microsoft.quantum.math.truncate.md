...
---
# <a name="truncate-function"></a>De functie truncate
...
Hiermee berekent u het integraal deel van een getal.
...
Zie [System. math. truncate](https://docs.microsoft.com/dotnet/api/system.math.truncate) voor meer informatie.