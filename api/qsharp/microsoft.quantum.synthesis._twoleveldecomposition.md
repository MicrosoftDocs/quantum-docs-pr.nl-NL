...
---
# <a name="_twoleveldecomposition-function"></a>Functie _TwoLevelDecomposition
...
## <a name="output--complexintint"></a>Uitvoer: ([complex](xref:Microsoft.Quantum.Math.Complex)[] [],[int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)) []
