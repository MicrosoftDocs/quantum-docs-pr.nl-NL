...
---
# <a name="quantumrombitstringwriterbyindex-function"></a>De functie QuantumROMBitStringWriterByIndex
...
## <a name="output--littleendianlittleendian--unit-adj--ctl"></a>Output: ([LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian),[LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian)) => [Unit](xref:microsoft.quantum.lang-ref.unit) ADJ + CTL
