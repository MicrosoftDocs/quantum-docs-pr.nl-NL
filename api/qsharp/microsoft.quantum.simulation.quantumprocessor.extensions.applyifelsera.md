...
### <a name="onresultzeroop--t--unit--is-adj"></a>onResultZeroOp: 'T => [eenheid](xref:microsoft.quantum.lang-ref.unit)  is ADJ
...
### <a name="onresultoneop--u--unit--is-adj"></a>onResultOneOp: ' U => [eenheid](xref:microsoft.quantum.lang-ref.unit)  is correctie
