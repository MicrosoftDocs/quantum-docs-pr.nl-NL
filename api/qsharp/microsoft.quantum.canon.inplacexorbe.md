...
ms.locfileid: "92704125"
---
# <a name="inplacexorbe-operation"></a>Bewerking InPlaceXorBE
...
> [!WARNING]
> InPlaceXorBE is afgeschaft. Gebruik <xref:ApplyReversedOpLECA(ApplyXorInPlace(value, _), target)> in plaats daarvan.
>
> Deze bewerking is verwijderd.
...
### <a name="target--bigendian"></a>doel: [BigEndian](xref:Microsoft.Quantum.Arithmetic.BigEndian)
