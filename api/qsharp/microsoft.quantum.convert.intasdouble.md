...
---
# <a name="intasdouble-function"></a>De functie IntAsDouble
...
Converteert een opgegeven geheel getal naar een equivalent drijvende-komma getal met dubbele precisie.
...
Zie [C# Convert. ToDouble](https://docs.microsoft.com/dotnet/api/system.convert.todouble?view=netframework-4.7.1#System_Convert_ToDouble_System_Int64_) voor meer informatie.