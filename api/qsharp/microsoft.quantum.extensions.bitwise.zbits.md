...
ms.locfileid: "98849953"
---
# <a name="zbits-function"></a>De functie ZBits

Naam ruimte: [micro soft. Quantum. Extensions. bitsgewijze](xref:Microsoft.Quantum.Extensions.Bitwise)

Pakket: [micro soft. Quantum. QSharp. core](https://nuget.org/packages/Microsoft.Quantum.QSharp.Core)


> [!WARNING]
> ZBits is afgeschaft. Gebruik <xref:Microsoft.Quantum.Bitwise.ZBits> in plaats daarvan.
>
> Gebruik @"microsoft.quantum.bitwise.zbits".
...
### <a name="paulies--pauli"></a>Paul: [Pauli](xref:microsoft.quantum.lang-ref.pauli)[]
