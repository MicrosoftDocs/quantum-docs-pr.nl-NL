...
---
# <a name="_continuedfractionconvergenti-function"></a>Functie _ContinuedFractionConvergentI
...
Interne recursieve aanroep voor het berekenen van de GCD met een gebonden
...
## <a name="output--fraction"></a>Uitvoer: [breuk](xref:Microsoft.Quantum.Math.Fraction)
