...
ms.locfileid: "96196511"
---
# <a name="winedata-operation"></a>Bewerking WineData

Naam ruimte: [micro soft. Quantum. MachineLearning. data sets](xref:Microsoft.Quantum.MachineLearning.Datasets)
...
## <a name="output--labeledsample"></a>Uitvoer: [LabeledSample](xref:Microsoft.Quantum.MachineLearning.LabeledSample)[]
