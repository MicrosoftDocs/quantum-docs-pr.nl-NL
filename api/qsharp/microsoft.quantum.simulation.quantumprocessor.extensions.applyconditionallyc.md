...
### <a name="onequalop--t--unit--is-ctl"></a>onEqualOp: 'T => [eenheid](xref:microsoft.quantum.lang-ref.unit)  is CTL
...
### <a name="onnonequalop--u--unit--is-ctl"></a>onNonEqualOp: ' U => [eenheid](xref:microsoft.quantum.lang-ref.unit)  is CTL
