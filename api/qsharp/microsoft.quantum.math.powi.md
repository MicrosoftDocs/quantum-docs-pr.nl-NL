...
ms.locfileid: "96194675"
---
# <a name="powi-function"></a>De functie PowI
...
Retourneert een getal verheven tot een opgegeven macht.
...
Het getal $a $ dat moet worden gegenereerd.


### <a name="power--int"></a>energie: [int](xref:microsoft.quantum.lang-ref.int)

De Power $b $ waarop $a $ moet worden gegenereerd.
