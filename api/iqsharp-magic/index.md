...
| [`%toffoli`](xref:microsoft.quantum.iqsharp.magic-ref.toffoli) | Voert een bepaalde functie of bewerking uit op de doelcomputer van de ToffoliSimulator-simulator |
| [`%who`](xref:microsoft.quantum.iqsharp.magic-ref.who) | Biedt acties met betrekking op de huidige werkruimte. |
| [`%workspace`](xref:microsoft.quantum.iqsharp.magic-ref.workspace) | Retourneert een lijst met alle bewerkingen en functies die in de huidige sessie zijn gedefinieerd, interactief of geladen vanuit de huidige werkruimte. |
