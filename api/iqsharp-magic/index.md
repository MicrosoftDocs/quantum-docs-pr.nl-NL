...
| [`%azure.submit`](xref:microsoft.quantum.iqsharp.magic-ref.azure.submit) | Hiermee wordt een taak verzonden naar een Azure Quantum-werkruimte. |
| [`%azure.target`](xref:microsoft.quantum.iqsharp.magic-ref.azure.target) | Hiermee wordt het actieve uitvoeringsdoel voor de verzending van een Q#-taak ingesteld of weergegeven in een Azure Quantum-werkruimte. |
