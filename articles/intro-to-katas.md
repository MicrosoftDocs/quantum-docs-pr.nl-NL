...
De [Quantum Katas](https://github.com/Microsoft/QuantumKatas/) bestaan uit een open source-verzameling zelfstudies en een reeks programmeeroefeningen die u in uw eigen tempo kunt uitvoeren en waarin de verschillende elementen van kwantumcomputing en Q#-programmering aan bod komen.
...
U kunt de katas gebruiken in de omgeving van uw keuze:
...
* [Kwantumpoorten herkennen](https://github.com/microsoft/QuantumKatas/tree/master/BasicGates)
* [Kwantumsuperpositie maken](https://github.com/microsoft/QuantumKatas/tree/master/Superposition)
* [Kwantumtoestanden onderscheiden met metingen](https://github.com/microsoft/QuantumKatas/tree/master/Measurements)
* [Gezamenlijke metingen](https://github.com/microsoft/QuantumKatas/tree/master/JointMeasurements)
...
* [BB84-protocol voor distributie van kwantumsleutels](https://github.com/microsoft/QuantumKatas/tree/master/KeyDistribution_BB84)
* Kwantumfoutcorrectie: [bit-flip-foutcorrectiecode](https://github.com/microsoft/QuantumKatas/tree/master/QEC_BitFlipCode)
* [Faseschatting](https://github.com/microsoft/QuantumKatas/blob/master/PhaseEstimation)
* Kwantumrekenkunde: [ripple-carry toevoegingen bouwen](https://github.com/microsoft/QuantumKatas/blob/master/RippleCarryAdder)
