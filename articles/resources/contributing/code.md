...
Lokale tests kunnen worden uitgevoerd met Visual Studio test Explorer of de `dotnet test` opdracht, zodat u uw bijdrage kunt controleren voordat u een pull-aanvraag opent.
...
Wanneer u klaar bent om uw werk bij te dragen, verzendt u een pull-aanvraag via GitHub naar de bijbehorende opslag plaats.
Het team zal controleren en feedback geven. Alle opmerkingen moeten worden beantwoord en opgelost en alle controles moeten worden door gegeven voordat de code wordt samengevoegd met de `main` vertakking.
...
In dergelijke gevallen kunt u het beste uw eigen opslag plaats---deel van de kracht van de Quantum Development Kit maken, waarmee u eenvoudig uw eigen bibliotheken kunt maken en distribueren met behulp van GitHub en NuGet.org, op dezelfde manier als u de Canon-en chemie-bibliotheken vandaag nog distribueert.
