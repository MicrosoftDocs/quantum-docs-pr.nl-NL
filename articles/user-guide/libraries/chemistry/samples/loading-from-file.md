---
title: Hamiltoniaan uit een bestand laden
description: Meer informatie over het automatisch genereren van een grote Hamiltonian met het Broombridge-schema.
author: guanghaolow
ms.author: gulow
ms.date: 10/23/2018
...
Laten we het voor beeld van het stikstof molecuul overwegen, dat wordt vermeld in de `IntegralData/YAML` map van de opslag plaats voor beelden. De methode voor het laden van het `Broombridge` schema is eenvoudig.
