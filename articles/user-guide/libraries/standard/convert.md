---
title: 'Type conversies in de :::no-loc(Q#)::: standaard bibliotheken'
description: 'Meer informatie over de algemene en door de gebruiker gedefinieerde type conversie functies in de :::no-loc(Q#)::: standaard bibliotheken.'
author: cgranade
...
<span data-ttu-id="96378-104">:::no-loc(Q#)::: is een **sterk getypeerde** taal.</span><span class="sxs-lookup"><span data-stu-id="96378-104">:::no-loc(Q#)::: is a **strongly-typed** language.</span></span>
<span data-ttu-id="96378-105">Met name :::no-loc(Q#)::: wordt niet impliciet gecast tussen verschillende typen.</span><span class="sxs-lookup"><span data-stu-id="96378-105">In particular, :::no-loc(Q#)::: does not implicitly cast between distinct types.</span></span> <span data-ttu-id="96378-106">Bijvoorbeeld, `1 + 2.0` is geen geldige :::no-loc(Q#)::: expressie.</span><span class="sxs-lookup"><span data-stu-id="96378-106">For instance, `1 + 2.0` is not a valid :::no-loc(Q#)::: expression.</span></span>
<span data-ttu-id="96378-107">Biedt in plaats daarvan :::no-loc(Q#)::: diverse typen conversie functies voor het samen stellen van nieuwe waarden van een bepaald type.</span><span class="sxs-lookup"><span data-stu-id="96378-107">Rather, :::no-loc(Q#)::: provides a variety of type conversion functions for constructing new values of a given type.</span></span>
...
<span data-ttu-id="96378-112">Ten slotte :::no-loc(Q#)::: biedt de standaard bibliotheek een aantal door de gebruiker gedefinieerde typen, zoals <xref:Microsoft.Quantum.Math.Complex> en <xref:Microsoft.Quantum.Arithmetic.LittleEndian> .</span><span class="sxs-lookup"><span data-stu-id="96378-112">Finally, the :::no-loc(Q#)::: standard library provides a number of user-defined types such as <xref:Microsoft.Quantum.Math.Complex> and <xref:Microsoft.Quantum.Arithmetic.LittleEndian>.</span></span>
